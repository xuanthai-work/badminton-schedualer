...
const vi = {
  ...
  auth: {
    ...
    forgotHint:
      "Nhập email hoặc tên đăng nhập, chúng tôi sẽ gửi link đặt lại mật khẩu vào email của bạn.",
    forgotSend: "Gửi link đặt lại",
    forgotSent:
      "Đã gửi! Kiểm tra hộp thư (cả mục spam) và mở link trong email.",
    backToLogin: "← Quay lại đăng nhập",
    resetTitle: "Tạo mật khẩu mới",
    resetChecking: "Đang kiểm tra link...",
    resetInvalid: "Link không hợp lệ hoặc đã hết hạn. Hãy yêu cầu link mới.",
    resetNewPassword: "Mật khẩu mới",
    resetConfirmPassword: "Nhập lại mật khẩu mới",
    resetTooShort: "Mật khẩu phải có ít nhất 6 ký tự.",
    resetMismatch: "Mật khẩu nhập lại không khớp.",
...
const en: typeof vi = {
  ...
  auth: {
    ...
    forgotHint:
      "Enter your email or username and we'll send a password-reset link to your email.",
    forgotSend: "Send reset link",
    forgotSent: "Sent! Check your inbox (and spam) and open the link.",
    ...
    resetSuccess: "Password changed! Redirecting...",
  },
  dashboard: {
    eyebrow: "Dashboard",
    myGroups: "My groups",
